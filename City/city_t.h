...
public:
    city_t(const std::string &name, const location_t &location) : _name(name), _location(location) {}

    city_t(const std::string &name, const int x, const int y) : _name(name), _location(x, y) {}
