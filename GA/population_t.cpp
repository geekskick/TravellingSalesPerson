...
//--------------------
void population_t::set_tour(const size_t idx, tour_t t) { _tours[idx] = t; }

//--------------------
tour_t &population_t::get_tour(const size_t idx) { return _tours[idx]; }

//--------------------
tour_t population_t::get_fittest(void) { return *std::max_element(_tours.begin(), _tours.end(), comparison_function); }

//--------------------
size_t population_t::get_size(void) const { return _tours.size(); }
