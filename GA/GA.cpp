...
double GA::get_mutation_rate(void) const { return _mutation_rate; }
size_t GA::get_tournament_size(void) const { return _tournament_size; }
bool GA::is_elitist(void) const { return _elitist; }

void GA::set_tournament_size(const size_t s) { _tournament_size = s; }
void GA::set_mutation_rate(const double m) { _mutation_rate = m; }
void GA::set_elitism(const bool e) { _elitist = e; }
